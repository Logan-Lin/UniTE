...
class InducedAttEncoder(Encoder):
    """
    Induced Attention Encoder used in MMTEC.
    Lin, Yan, et al. "Pre-Training General Trajectory Embeddings With Maximum Multi-View Entropy Coding." IEEE Transactions on Knowledge and Data Engineering (2023).
    """
