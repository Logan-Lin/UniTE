...
from modules.model.base import Encoder, Decoder
...
class BERTEncoder(Encoder):
    """
    BERT Contrastive LM Encoder used in START.
    Jiang, Jiawei, et al. "Self-supervised trajectory representation learning with temporal regularities and travel semantics." 2023 IEEE 39th international conference on data engineering (ICDE). IEEE, 2023.
    """
