...
class t2vecEncoder(Encoder):
    """
    t2vec Encoder.
    Li, Xiucheng, et al. "Deep representation learning for trajectory similarity computation." 2018 IEEE 34th international conference on data engineering (ICDE). IEEE, 2018.
    """
